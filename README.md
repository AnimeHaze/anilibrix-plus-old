...
* Добавлена внопка назад и вперед
* Добавлена кнопка поделится на странице релиза
* Кеш постеров и статичных картинок
* Прогресс файлы не удаляются при удалении приложения
* Вывод количества серий в сезоне (если таковое известно) в карточках релизов в избранном
* Изменены категории в мета информации пакетов для Linux на `AudioVideo;Video;Player;`
* Версия ARM для macOS (приложение работает без Rosetta2 в соответствующей версии для ARM)
