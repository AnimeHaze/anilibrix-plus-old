...
import { APICacheService } from './utils/api-cache/api-cache-service';
import { APIController } from './utils/api-cache/api-cache-controller';
let proxyServer
...
const cachePath = path.join(app.getPath('userData'), 'media-cache')
