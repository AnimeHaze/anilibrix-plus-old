      ...
      * {
      ...
      .container {
        ...
        background:
          ...
          linear-gradient(145deg, #181818, #292929);
      }
      ...
      .logo {
        ...
        filter: drop-shadow(0 0 20px #ff001e);
      }
...
<div class="container">
    ...
    <div class="actions">
        ...
        <button class="action" id="close">
            <%= t('common.close') %>
        </button>

        <button class="action" id="restart">
            <%= t('common.restart') %>
        </button>
    </div>
</div>
