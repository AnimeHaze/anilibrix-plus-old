export default {
  ...
  settings: {
    ...
    systemDescription: 'Here you can configure automatic release updates, and other application settings.',
  ...
  release: {
    ...
    progressAllWatched: 'All episodes watched {episodes} {total}',
    progressAllWatchedDense: 'All episodes {episodes} {total}',
